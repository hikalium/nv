...
void NV_saveCodeGraph_trace(const NV_ID *n);
void NV_saveCodeGraphForVisualization(const NV_ID *codeGraphRoot, const char *path_prefix);
...
int NV_Dict_foreach(const NV_ID *dict, void *d, int (*f)(void *d, const NV_ID *reln, const NV_ID *rel, const NV_ID *to));
int NV_Dict_foreachWithRelFilter(const NV_ID *dict, void *d, int (*f)(void *d, const NV_ID *reln, const NV_ID *rel, const NV_ID *to), int (*filter)(const NV_ID *rel));
...
NV_ID NV_Node_createWithTypeAndData(NV_NodeType type, const void *data, int32_t size);
NV_ID NV_Node_createWith_ID_Type_Data_Size(const NV_ID *id, NV_NodeType type, const void *data, int32_t size);
...
void NV_Lang_addOp(const NV_ID *opDict, const char *ident, int32_t prec, const NV_ID *func);
void NV_Lang_addOpWithFuncStr(const NV_ID *opDict, const char *token, int32_t prec, const char *funcStr);
...
NV_ID NV_Lang_parseCodeBlock(const NV_ID *tList, int index, const char *openTerm, const char *closeTerm);
NV_ID NV_Lang_parseStrLiteral(const NV_ID *tList, int index);
NV_ID NV_Lang_parseToCodeGraph(const NV_ID *baseTokenList, const NV_ID *opDict, const NV_Lang_ParseTag funcList[]);
NV_ID NV_evalGraph(const NV_ID *codeGraphRoot, const NV_ID *scope, NV_Lang_EvalTag *evalList);
...
NV_ID NV_NodeID_createRel_OnDupUpdate(const NV_ID *from, const NV_ID *rel, const NV_ID *to, NV_ID (*find)(const NV_ID *from, const NV_ID *rel));
NV_ID NV_NodeID_createRelation(const NV_ID *from, const NV_ID *rel, const NV_ID *to);
NV_ID NV_NodeID_createRelationWithID(const NV_ID *relnid, const NV_ID *from, const NV_ID *rel, const NV_ID *to);
...
const NV_Node *NV_NodeID_getRelNodeFromWithCmp(const NV_ID *from, const NV_ID *rel, int (*cmp)(const NV_ID *p, const NV_ID *q));
...
NV_ID NV_parseToCodeGraph_nothing(const NV_ID *tokenList, NV_ID *lastNode, NV_OpPointer *p, const char *ident);
NV_ID NV_parseToCodeGraph_infixOp(const NV_ID *tokenList, NV_ID *lastNode, NV_OpPointer *p, const char *ident);
NV_ID NV_parseToCodeGraph_prefixOp(const NV_ID *tokenList, NV_ID *lastNode, NV_OpPointer *p, const char *ident);
NV_ID NV_parseToCodeGraph_postfixOp(const NV_ID *tokenList, NV_ID *lastNode, NV_OpPointer *p, const char *ident);
NV_ID NV_parseToCodeGraph_codeblock(const NV_ID *tokenList, NV_ID *lastNode, NV_OpPointer *p, const char *ident);
NV_ID NV_parseToCodeGraph_strLiteral(const NV_ID *tokenList, NV_ID *lastNode, NV_OpPointer *p, const char *ident);
